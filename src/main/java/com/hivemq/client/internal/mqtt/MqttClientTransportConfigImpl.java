...
public class MqttClientTransportConfigImpl implements MqttClientTransportConfig {
    ...
    MqttClientTransportConfigImpl(
            ...
            final @Nullable MqttWebSocketConfigImpl webSocketConfig, final @Nullable MqttProxyConfigImpl proxyConfig) {
    ...
    public boolean equals(final @Nullable Object o) {
        ...
        return serverAddress.equals(that.serverAddress) && Objects.equals(sslConfig, that.sslConfig) &&
                Objects.equals(webSocketConfig, that.webSocketConfig) && Objects.equals(proxyConfig, that.proxyConfig);
    }
